...
(function() {
	...
	function YB_addFeed(u) {
		document.querySelector('#content h1').innerHTML = 'Add feed (feature in beta!)';
		...
		if (u.length>6) {
			...
			c.innerHTML += '<br><br><span id="yy_add" class="button">Add feed</span> <span id="yy_cancel" class="button">Cancel</span>';
	...
	if (location.pathname == "/settings") settingPage();
