/**
 * slightly edited booru.match_query (https://github.com/derpibooru/philomena/blob/master/assets/js/match_query.js) to
...
let _ = (() => {
    ...
    async function SearchTermWithExtension(termStr, extTags, extPrefixes) {
        ...
        if (extPrefix) {
            ...
            if (typeof extTag.result === 'string') {
                ...
                console.error('Unrecognized result of ' + termStr);
            }
        }
        return new SearchTerm(termStr);
    }
    ...
    SearchTerm.prototype.toString = function () {
                ...
                if (match) {
                    ...
                    switch (tokenName) {
                        ...
                        default:
                            ...
                            if (searchTerm) {
                                searchTerm.append(match, extensions);
                            }
                    }
...
let parseSearch = _.parseSearch;
let SearchAST = _.SearchAST;
let SearchTerm = _.SearchTerm;
